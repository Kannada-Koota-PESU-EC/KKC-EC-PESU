export interface Member {
  ...
  role: 'Club Head' | 'Club Vice Head' | 'Domain Head' | 'Member';
...
export const teamData: Record<number, Member[]> = {
  ...
  2026: [
    ...
    },
    {
      ...
      role: 'Domain Head',
      domain: 'ಈವೆಂಟ್ / Event Management',
      year: 2026,
      photo: '/Hero/KK1.jpeg',
      linkedin: 'url',
      instagram: 'url',
    ...
    {
      id: 'dh-2026-3',
      name: 'ಪಲ್ಲಾ ತೇಜೇಶ್ವರ್ ರೆಡ್ಡಿ / Palla Tejeswar Reddy',
      role: 'Domain Head', 
      domain: 'ಲಾಜಿಸ್ಟಿಕ್ಸ್ / Logistics',
      year: 2026,
      photo: '/Hero/KK1.jpeg',
    ...
    {
      id: 'dh-2026-4',
      name: 'ಸ್ನೇಹ ಎಚ್ ಎಸ್ / Sneha H S',
      role: 'Domain Head', 
      domain: 'ಸಾಂಸ್ಕೃತಿಕ / Culturals',
      year: 2026,
      photo: '/Hero/KK1.jpeg',
    ...
    },
    {
      ...
      year: 2026,
      photo: '/Hero/KK1.jpeg',
      instagram: 'https://www.linkedin.com/in/deepthi-venkatesh-1a5a80350/',
      linkedin: 'https://www.instagram.com/deepthi_venkatesh211/',
    },
    {
      id: 'dh-2026-6',
      name: 'ಅಭಿರಾಮ ಹೆಚ್ ವೈ / Abhirama H Y',
      role: 'Domain Head', 
      domain: 'ಇಂಚರ / Cultural',
      year: 2026,
      photo: '/Hero/KK1.jpeg',
    ...
    },
    {
      ...
      role: 'Domain Head', 
      domain: 'ವಿನ್ಯಾಸ ಮತ್ತು ವೀಡಿಯೊ ಎಡಿಟಿಂಗ್ / Design and Video Editing ',
      year: 2026,
      photo: '/Hero/KK1.jpeg',
    ...
    {
      id: 'dh-2026-12',
      name: 'ತೇಜಸ್ವಿ ಗಣಪತಿ ಹೆಡೆ / Tejaswi Ganapati Hede',
      role: 'Domain Head', 
      domain: 'ವಿಷಯ ಬರವಣಿಗೆ / Content Writing',
      year: 2026,
      photo: '/Hero/KK1.jpeg',
    ...
    },
    {
      ...
      year: 2026,
      photo: '/Hero/KK1.jpeg',
      linkedin: 'https://www.linkedin.com/in/ashmitha-sri-anand-92849231b?utm_source=share_via&utm_content=profile&utm_medium=member_android',
      instagram: 'https://www.instagram.com/justagirl10451',
    },
    {
      id: 'dh-2026-14',
      name: 'ಯಶಸ್ ಎಸ್.ಎನ್ / Yashas SN',
      role: 'Domain Head', 
      domain: ' ಸಾರ್ವಜನಿಕ ಸಂಪರ್ಕಗಳು / Public Relations',
      year: 2026,
      photo: '/Hero/KK1.jpeg',
...
export const getClubHeads = (year: number): Member[] => {
  ...
  return team.filter(member => member.role === 'Club Head'|| member.role === 'Club Vice Head');
};
