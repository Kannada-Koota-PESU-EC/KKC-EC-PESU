...
export default function Hero({ title = "ಕನ್ನಡ ಕೂಟ EC PES" }: HeroProps) {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-background/82 via-background/62 to-background/44 backdrop-blur-[1px] overflow-hidden">
